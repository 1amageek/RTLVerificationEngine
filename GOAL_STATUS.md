...
- The Foundation boundary is implemented as a direct execution conformance and a loss-checked evidence projection. Full replacement of the lifecycle-owned `XcircuitePackage` request/result models remains a separate migration milestone and is not claimed here.
