...
| Contract test | Passed | timeout-bounded SwiftPM test: 42 tests in 6 suites; qualification-input wiring, mapped pass/mismatch, persisted corpus runs, oracle evidence artifacts, frontend top policy, freshness, scope binding and timeout fixtures included |
