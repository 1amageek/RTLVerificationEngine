...
| M1 | Reproducible multi-file RTL frontend | M0 contracts | Preprocessor/elaboration policy, source map, stable entity IDs, language coverage matrix | Declared subset includes top-module policy, source-set provenance, includes and deterministic defines; full IEEE elaboration pending |
