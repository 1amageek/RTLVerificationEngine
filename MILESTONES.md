...
|---|---|---|---|---|
| M0 | Contract integrity and explicit qualification state | Existing request/result protocols | Versioned qualification report, exact-schema policy gate, blocked diagnostics | Complete for schema v1 |
...
| M7 | Headless flow and human review | M6 selection policy | Direct protocol composition in Xcircuite, immutable artifacts, resume/cancel, review bundle and approval gate | Serial Xcircuite regression passes 550 tests in 59 suites, including RTL stage/resume, independent oracle/process evidence flow, LogicEngine composition, review and end-to-end contracts; full workspace qualification remains open |
