...
| M5 | Independent validation | M2–M4 implementations | Retained corpus, expected findings, oracle correlation, false-positive/negative report | Persisted corpus runner, typed qualification input, artifact-bound oracle evidence contract and rejection paths complete; external oracle evidence pending |
