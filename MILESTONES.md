...
| M1 | Reproducible multi-file RTL frontend | M0 contracts | Preprocessor/elaboration policy, source map, stable entity IDs, language coverage matrix | Canonical SystemVerilogFrontend adapter includes top-module policy, source-set provenance, includes, deterministic defines, parameters, case statements, hierarchy and generate blocks; full IEEE elaboration pending |
